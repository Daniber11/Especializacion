...
public class StringsThirdAssignments {
	...
	public void howManyGenes() {
		...
		//System.out.println("How many genes are: " + g);
		System.out.println("vaos" + g);
		System.out.println(">60 " + count);
	}
	...
	public void processGenes() {
		...
		int counCtg = countCTG(dna);
		double ra = cgRatio(dna);
