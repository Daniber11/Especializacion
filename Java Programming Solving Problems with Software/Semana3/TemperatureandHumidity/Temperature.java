...
public class Temperature {
	...
	System.out.println("El dia mas frio esta en el archivo: " + fileName);

	FileResource fr      = new FileResource(f);
	CSVParser parser     = fr.getCSVParser();
	CSVRecord lowestTemp = coldestHourInFile(parser);

	System.out.println("La temperatura mas fria es: " + lowestTemp.get("TemperatureF"));

	System.out.println("La temperatura en el dia mas frio fue");
	...
	double avg = averageTemperatureInFile(parser);
    	...
    	System.out.println("El promedio de temperatura es " + avg);
    }
