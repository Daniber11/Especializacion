...
public class GladLib {
    ...
    public GladLib(String source) {
        ...
        // crear un contructor de números aleatorios
        myRandom = new Random();
    }
    ...
    private String randomFrom(ArrayList<String> source) {
        // Devuelve el siguiente valor aleatorio entero del constructor de números aleatorios. 
        // source.size () número de elementos en ArrayList.  
        int index = myRandom.nextInt(source.size());
        return source.get(index);        
    }
        
    // Toma una etiqueta de String y reemplazarla con una String aleatoria en ArrayList    
