...
public class RecommendationRunner implements Recommender {
    ...
    public void printRecommendationsFor (String webRaterID) {
        ...
        if (similarRatings.size() == 0) {
            System.out.println("No se encontraron películas que coincidan");
        } else {
            String header = ("<table> <tr> <th>Título de la película</th> <th>Valor de calificación</th>  <th>Generos</th> </tr>");
            String body = "";
